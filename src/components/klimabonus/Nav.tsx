    ...
    <header id="top">
      ...
      <div className="border-b border-border bg-secondary text-secondary-foreground">
        <div className="mx-auto flex max-w-6xl items-center gap-3 px-4 py-1.5 text-xs">
          <span className="opacity-90">Information zum Volksbank Investment-Check · Fondsanlage</span>
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              <div className="text-base font-semibold text-foreground">Volksbank</div>
              <div className="text-[11px] uppercase tracking-wider text-muted-foreground">Investment-Check</div>
            </div>
          </Link>
